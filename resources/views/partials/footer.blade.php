    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mt-16 flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex space-x-4">
                <a href="#" class="bg-white rounded-full p-2 flex items-center justify-center w-8 h-8">
                    <span class="sr-only">Twitter</span>
                    <i class="fab fa-twitter text-black w-4 h-4"></i>
                </a>
                <a href="#" class="bg-white rounded-full p-2 flex items-center justify-center w-8 h-8">
                    <span class="sr-only">LinkedIn</span>
                    <i class="fab fa-linkedin text-black w-4 h-4"></i>
                </a>
                <a href="#" class="bg-white rounded-full p-2 flex items-center justify-center w-8 h-8">
