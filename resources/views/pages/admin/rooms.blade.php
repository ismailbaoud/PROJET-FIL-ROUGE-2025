        ...
        <div class="max-w-7xl mx-auto">
            <div class="p-6 min-h-screen">
                ...
                <div class="mb-4 flex flex-col md:flex-row md:justify-between">
                    <input type="text" placeholder="🔍 Rechercher une Green Room..." class="p-2 border rounded-md w-full md:w-1/3 mb-2 md:mb-0">
                    ...
                    <table class="w-full border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-100">
                                ...
                                <td class="p-3"><span class="px-2 py-1 rounded-md text-white bg-red-500">Fermé</span></td>
