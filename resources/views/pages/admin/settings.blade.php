                    ...
                    <div class="p-6  min-h-screen">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="site-name" class="block text-sm font-medium text-gray-700">Nom du
                                        Site</label>
                                    <input type="text" id="site-name" class="mt-1 p-2 border rounded-md w-full"
                                        placeholder="Nom du site" />
                                </div>
                                <div>
                                    <label for="site-email" class="block text-sm font-medium text-gray-700">Email du
                                        Site</label>
                                    <input type="email" id="site-email" class="mt-1 p-2 border rounded-md w-full"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="password-policy" class="block text-sm font-medium text-gray-700">Politique
                                ...
                                <div>
                                    <label for="two-factor" class="block text-sm font-medium text-gray-700">Authentification
                                        à Deux Facteurs</label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="email-notifications"
                                        class="block text-sm font-medium text-gray-700">Notifications par Email</label>
                                ...
                                <div>
                                    <label for="smtp-server" class="block text-sm font-medium text-gray-700">Serveur
                                        SMTP</label>
                                    <input type="text" id="smtp-server" class="mt-1 p-2 border rounded-md w-full"
