                            ...
                            <table class="w-full border-collapse">
                                ...
                                <tbody>
                                    <tr class="border-b hover:bg-gray-100">
                                        ...
                                        <td class="p-3">$500</td>
                                        <td class="p-3"><span
                                                class="px-2 py-1 rounded-md text-white bg-green-500">Complétée</span></td>
                                    ...
                                    <tr class="border-b hover:bg-gray-100">
                                        ...
                                        <td class="p-3">$200</td>
                                        <td class="p-3"><span class="px-2 py-1 rounded-md text-white bg-yellow-500">En
                                                Attente</span></td>
                                    ...
                                    <tr class="border-b hover:bg-gray-100">
                                        ...
                                        <td class="p-3"><span
                                                class="px-2 py-1 rounded-md text-white bg-red-500">Échouée</span></td>
