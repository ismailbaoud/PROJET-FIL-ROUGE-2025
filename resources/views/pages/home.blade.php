...
@Section('main')
    <main class="">
        ...
        <div class="px-6 md:px-20 pb-10 md:pb-20 pt-10 md:pt-30 bg-gradient-to-tr from-white via-white via-30% to-[#E8F5E9]">
                ...
                <div class="flex justify-center items-center">
                    <div class="bg-white p-6 rounded-xl shadow-md border border-gray-200 w-full max-w-md">
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600 font-semibold text-sm bg-gray-100 px-3 py-1 rounded-full">Élevé</span>
                            <span class="px-3 py-1 text-gray-700 bg-gray-100 border border-gray-300 rounded-full text-xs">En cours</span>
                        </div>
                        <h2 class="text-xl font-semibold mt-4 text-gray-800">Contournement d’authentification via OAuth</h2>
                        <p class="text-gray-500 text-sm">Signalé par <span class="font-medium text-gray-700">ethical_hacker</span> • il y a 1 semaine</p>
                        ...
                        <div class="mt-6 flex justify-between items-center">
                            ...
                            <button class="bg-gray-600 text-white px-5 py-2 rounded-lg text-sm font-medium shadow-sm hover:bg-gray-700 transition">
                                Voir le rapport
                            </button>
                        </div>
