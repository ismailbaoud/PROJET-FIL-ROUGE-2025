                    ...
                    <div class="bg-white p-6 border border-gray-200 rounded-lg mb-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-500">Microsoft Corporation • Auto-reload when balance below
                                    $50,000</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="fixed inset-0 bg-gray-500 bg-opacity-75 hidden" id="payment-modal">
                        <div class="flex items-center justify-center min-h-screen">
                            <div class="bg-white rounded-lg max-w-md w-full p-6">
                                ...
                                <div class="mb-4">
                                    <p class="text-sm text-gray-500">You are about to process payments for 5 selected
                                        reports with a total amount of $90,500.00.</p>
                                </div>
                            ...
                            <div class="bg-white rounded-lg max-w-md w-full p-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="text"
                                            class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md py-2"
                                            placeholder="0.00" value="100,000.00">
