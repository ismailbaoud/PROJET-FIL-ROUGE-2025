            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-gray-900">Microsoft Security Programs</h1>
                    ...
                    <button onclick="toggleForm('createForm')" 
                            class="flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <div id="createForm" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
                    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 mb-8">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div class="flex flex-wrap gap-3">
                            <div class="relative">
                                <select id="statusFilter" class="appearance-none pl-4 pr-10 py-2.5 bg-white border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">
                            ...
                            <div class="relative">
                                <select id="sortBy" class="appearance-none pl-4 pr-10 py-2.5 bg-white border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">
                            ...
                            <button onclick="applyFilters()" class="flex items-center gap-2 px-4 py-2.5 bg-blue-600 text-white rounded-lg text-sm hover:bg-blue-700 shadow-sm hover:shadow-md transition-all duration-300">
                        ...
                        <div class="relative w-full md:w-64">
                            <input type="text" placeholder="Search programs..." class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">
                            ...
                            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-300">
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div class="text-lg font-semibold text-gray-900">{{ $program->title }}</div>
                                            <div class="text-sm text-gray-600 mt-1">{{ Str::limit($program->description, 50) }}</div>
                                        </div>
                                    </div>
                                    
                                    <!-- Bounty Range -->
                                    <div class="text-sm text-gray-900">
                                        <span class="font-medium">Bounty:</span> ${{ number_format($program->min_reward) }} - ${{ number_format($program->max_reward) }}
                                    </div>
                                    
                                    <!-- Reports -->
                                    <div class="flex items-center gap-3">
                                        <div class="w-20 bg-gray-200 rounded-full h-2">
                                            <div class="bg-blue-600 h-2 rounded-full" style="width: {{ min(($program->reports_count / 50) * 100, 100) }}%"></div>
                                        </div>
                                        <span class="text-sm text-gray-900">{{ $program->reports_count }} Reports</span>
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-4">
                                        <a href="{{ route('programDetails', $program->id) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View</a>
                ...
                @else
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 text-center">
                        ...
                        <a href="{{ route('programs') }}" class="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm shadow-sm hover:shadow-md transition-all duration-300">
