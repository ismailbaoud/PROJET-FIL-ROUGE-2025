                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                        ...
                        @if (Auth::id() === $user->id)
                            <form action="{{ route('hunter_settings_update') }}" method="POST">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <label for="rewards"
                                            class="block text-sm font-medium text-gray-700">Rewards</label>
                                        <input type="text" id="rewards" value="{{ $profile->rewards ?? 'None' }}"
                                            readonly
                                            class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm px-3 py-2 bg-gray-100 cursor-not-allowed">
                                    </div>
                        ...
                        @else
                            <div class="space-y-4">
                                <!-- Username -->
                                <div>
                                    <label for="username_static"
                                        class="block text-sm font-medium text-gray-700">Username</label>
                                    <p id="username_static"
                                ...
                                <!-- Rewards -->
                                <div>
                                    <label for="rewards_static"
                                        class="block text-sm font-medium text-gray-700">Rewards</label>
                                    <p id="rewards_static"
                                        class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm px-3 py-2 bg-gray-100">
                                        {{ $profile->rewards ?? 'None' }}</p>
                                </div>

                                <!-- Country -->
                                <div>
                                    <label for="country_static"
                                        class="block text-sm font-medium text-gray-700">Country</label>
                                    <p id="country_static"
                                        class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm px-3 py-2 bg-gray-100">
                                        {{ $profile->country ?? 'N/A' }}</p>
                                </div>
