            ...
            <div class="w-[100%] mx-auto">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p class="text-gray-300 mt-1">Find and participate in security research programs</p>
                    </div>
                </div>

                <!-- Filters -->
                <div class="bg-gray-800 rounded-xl shadow-xs border border-gray-700 p-4 mb-6">
                    <div class="flex flex-col md:flex-row md:items-center gap-4">
                        <div class="relative flex-1">
                            ...
                            <input type="text" placeholder="Search programs..." class="block w-full pl-10 pr-3 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-gray-700 text-white placeholder-gray-400">
                        </div>
                        <div class="relative w-full md:w-48">
                            <select id="statusFilter" class="block w-full pl-3 pr-10 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 appearance-none bg-gray-700 text-white" onchange="applyFilters()">
                                <option value="">All Statuses</option>
                                <option value="accepted" {{ request('status') === 'accepted' ? 'selected' : '' }}>Active</option>
                                <option value="rejected" {{ request('status') === 'rejected' ? 'selected' : '' }}>Inactive</option>
                        ...
                        <div class="relative w-full md:w-48">
                            <select id="sortBy" class="block w-full pl-3 pr-10 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 appearance-none bg-gray-700 text-white" onchange="applyFilters()">
                    ...
                    <div class="bg-gray-800 rounded-xl shadow-xs border border-gray-700 overflow-hidden hover:shadow-md transition-shadow">
                        <div class="p-5">
                            ...
                            <div class="space-y-3 mb-4">
                                <div>
                                    <div class="text-xs font-medium text-gray-400 mb-1">Reward Range</div>
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <div>
                                        <div class="text-xs font-medium text-gray-400 mb-1">Reports</div>
                                        <div class="text-sm text-white">{{ $program->reports_count ?? 0 }}</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="bg-gray-800 rounded-xl shadow-xs border border-gray-700 p-10 text-center">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-white">No programs found</h3>
                    <p class="mt-1 text-sm text-gray-300">Try adjusting your search or filter to find what you're looking for.</p>
